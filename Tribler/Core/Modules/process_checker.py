...
class ProcessChecker(object):
    ...
    def __init__(self, state_directory=None):
        ...
        self.lock_file_path = path_util.join(self.state_directory, LOCK_FILE_NAME)

        if path_util.exists(self.lock_file_path):
    ...
    def create_lock_file(self):
        ...
        """
        if not path_util.exists(self.state_directory):
    ...
    def get_pid_from_lock_file(self):
        ...
        """
        if not path_util.exists(self.lock_file_path):
            return -1
