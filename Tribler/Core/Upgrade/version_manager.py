...
from Tribler.Core.simpledefs import STATEDIR_DB_DIR, STATEDIR_CHECKPOINT_DIR, STATEDIR_WALLET_DIR, STATEDIR_CHANNELS_DIR
        ...
        if base_state_directory.exists() and not conf_path.exists():
            ...
            for upgrade_dir in upgrade_dirs:
                if upgrade_dir in src_sub_dirs:
                    dir_copy(base_state_directory / upgrade_dir, new_state_dir / upgrade_dir)
