...
def create_dummy_logs(log_dir, process='core', log_message=None, num_logs=100):
    """
...
@pytest.mark.asyncio
async def test_debug_pane_core_logs_in_root_dir(tribler_root_dir, enable_api, session):
    """
